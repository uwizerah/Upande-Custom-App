...
# 		from upande_vf_custom.upande_vf_custom.doctype.vf_asset_repair_item.vf_asset_repair_item import (
# 			VFAssetRepairItem,
# 		)
...
# 		stock_items: DF.Table[VFAssetRepairItem]
...
# 						get_link_to_form("VF Asset Repair", self.name)
# 					),
# 				)
...
# 					"consumed_quantity": stock_item.consumed_quantity,
