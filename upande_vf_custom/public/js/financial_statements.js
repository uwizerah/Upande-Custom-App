frappe.provide("upande_vf_custom.financial_statements");

upande_vf_custom.financial_statements = {
	filters: get_filters(),
	baseData: null,
	formatter: function (value, row, column, data, default_formatter, filter) {
		...
		if (data && column.fieldname == "account") {
			...
			if (data.account) {
				column.link_onclick =
					"upande_vf_custom.financial_statements.open_general_ledger(" + JSON.stringify(data) + ")";
			}
			column.is_tree = true;
		}
	...
	onload: function (report) {
		...
		upande_vf_custom.financial_statements.filters = get_filters();
